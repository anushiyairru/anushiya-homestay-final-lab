...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    super.initState();
    _prnameEditingController.text = widget.product.homestayName.toString();
    _prdescEditingController.text = widget.product.homestayDesc.toString();
    _prpriceEditingController.text = widget.product.homestayPrice.toString();
    _prdelEditingController.text = widget.product.homestayDelivery.toString();
    _prqtyEditingController.text = widget.product.homestayQty.toString();
    _prstateEditingController.text = widget.product.homestayState.toString();
    _prlocalEditingController.text = widget.product.homestayLocal.toString();
  }
            ...
            Card(
              ...
              child: Container(
                  ...
                  child: CachedNetworkImage(
                    ...
                    fit: BoxFit.cover,
                    imageUrl:
                        "${ServerConfig.SERVER}/assets/homestayimages/${widget.product.homestayId}.png",
                  ...
                  SizedBox(
                    ...
                    child: Ink(
                      decoration: const ShapeDecoration(
                        color: Color.fromARGB(255, 109, 52, 6),
                        shape: CircleBorder(),
                      ),
                      child: IconButton(
  ...
  void _updateProduct() {
    ...
    http.post(Uri.parse("${ServerConfig.SERVER}/php/update_homestay.php"),
        body: {
          "productid": widget.product.homestayId,
