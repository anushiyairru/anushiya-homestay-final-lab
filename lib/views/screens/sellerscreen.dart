              ...
              ? Container(
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("assets/images/seller screen.jpg"),
                        fit: BoxFit.cover),
                  ),
                  child: Center(
              ...
              : Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Your current homestays (${productList.length} found)",
                        style: const TextStyle(
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "${ServerConfig.SERVER}/assets/homestayimages/${productList[index].homestayId}.png",
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Text(
                                              "RM ${double.parse(productList[index].homestayPrice.toString()).toStringAsFixed(2)}"),
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadProducts() {
    ...
    http
        .get(
      Uri.parse(
          "${ServerConfig.SERVER}/php/loadsellerhomestay.php?userid=${widget.user.id}"),
    )
        .then((response) {
  ...
  Future<void> _showDetails(int index) async {
    Homestay product = Homestay.fromJson(productList[index].toJson());
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text(
            "Delete ${truncateString(productList[index].homestayName.toString(), 15)}",
            style: TextStyle(),
          ),
  ...
  void _deleteProduct(index) {
    try {
      http.post(Uri.parse("${ServerConfig.SERVER}/php/delete_homestay.php"),
          body: {
            "productid": productList[index].homestayId,
          }).then((response) {
