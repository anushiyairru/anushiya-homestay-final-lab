...
class _BuyerProductDetailsState extends State<BuyerProductDetails> {
              ...
              children: [
                ...
                TableRow(children: [
                  ...
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${widget.product.homestayQty}",
                            style: const TextStyle(fontSize: 20.0))
                      ]),
                ]),
                TableRow(children: [
  ...
  Future<void> _onRoute() async {
    final Uri launchUri = Uri(
        ...
        path: "www.google.com/maps/@" +
            widget.product.homestayLat.toString() +
            "," +
            widget.product.homestayLng.toString() +
            "20z");
    await launchUrl(launchUri);
  }
  ...
  void _onShowMap() {
    double lat = double.parse(widget.product.homestayLat.toString());
    double lng = double.parse(widget.product.homestayLng.toString());
